...
epsilon = 10^(c(-7,-6.8,-6.6,-6.4,-6.2,-6,-5.8,-5.6,-5.4,-5.2,-5))
...
write.csv(yexpectedPDS,file="./Expected y at diagnosis/yexpectedPDS fine.csv")
write.csv(yexpectedNACT,file="./Expected y at diagnosis/yexpectedNACT fine.csv")
