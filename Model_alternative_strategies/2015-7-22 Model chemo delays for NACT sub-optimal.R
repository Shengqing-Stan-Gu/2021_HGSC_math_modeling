...
write.csv(cbind(postNACTx,postNACTy,SurvivalNACT,ChemocountNACT),file="./Survival NACT chemo delay/Survival 1 month sub-optimal.csv")
...
write.csv(cbind(postNACTx,postNACTy,SurvivalNACT,ChemocountNACT),file="./Survival NACT chemo delay/Survival 1.5 month sub-optimal.csv")
...
write.csv(cbind(postNACTx,postNACTy,SurvivalNACT,ChemocountNACT),file="./Survival NACT chemo delay/Survival 2 month sub-optimal.csv")
...
write.csv(cbind(postNACTx,postNACTy,SurvivalNACT,ChemocountNACT),file="./Survival NACT chemo delay/Survival 3 month sub-optimal.csv")
