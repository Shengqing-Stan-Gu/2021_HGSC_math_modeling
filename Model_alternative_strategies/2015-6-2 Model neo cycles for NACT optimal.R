...
write.csv(cbind(postNACTx,postNACTy,SurvivalNACT,ChemocountNACT),file="./Survival NACT/Survival 3 cycle optimal.csv")
...
write.csv(cbind(postNACTx,postNACTy,SurvivalNACT,ChemocountNACT),file="./Survival NACT/Survival 2 cycle optimal.csv")
...
write.csv(cbind(postNACTx,postNACTy,SurvivalNACT,ChemocountNACT),file="./Survival NACT/Survival 1 cycle optimal.csv")
